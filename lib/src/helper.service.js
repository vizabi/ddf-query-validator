...
exports.DEFAULT_REPOSITORY_HASH = exports.DEFAULT_REPOSITORY_BRANCH = exports.DEFAULT_REPOSITORY_NAME = exports.AVAILABLE_ORDER_BY_CLAUSE_VALUES = exports.AVAILABLE_FROM_CLAUSE_VALUES = exports.AVAILABLE_QUERY_OPERATORS = exports.RESERVED_VALUE = exports.RESERVED_KEY = exports.RESERVED_DRILL_UP = exports.RESERVED_UNIT = exports.RESERVED_DOMAIN = exports.RESERVED_CONCEPT_TYPE = exports.RESERVED_CONCEPT = exports.CONCEPT_TYPE_TIME = exports.CONCEPT_TYPE_ENTITY_SET = exports.CONCEPT_TYPE_ENTITY_DOMAIN = exports.CONCEPT_TYPE_STRING = exports.CONCEPT_TYPE_MEASURE = exports.CONCEPTS = exports.ENTITIES = exports.DATAPOINTS = exports.SCHEMAS = void 0;
...
function isSchemaQuery(query) {
    const fromClause = (0, get_1.default)(query, 'from');
...
function isEntityDomainOrSet(conceptType, allowedValues) {
    return (0, includes_1.default)(allowedValues, conceptType);
}
function isMeasure(conceptType) {
    return (0, includes_1.default)([exports.CONCEPT_TYPE_MEASURE], conceptType);
}
function isIndicator(conceptType) {
    return (0, includes_1.default)([exports.CONCEPT_TYPE_MEASURE, exports.CONCEPT_TYPE_STRING], conceptType);
}
